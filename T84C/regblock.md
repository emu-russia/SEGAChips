...
|n_idu_clr| |0: Установить выход IDU в 0 независимо от результатов вычислений (Note: выход IDU в инверсной логике и этот управляющий сигнал тоже в инверсной логике, грёбаные неформалы.. То есть когда этот n_idu_clk=0 - выход равен 1. Будьте внимательны)|
